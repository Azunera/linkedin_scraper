...
def parse_job_page(page, html: HTMLParser, job_card_num, skills_list, skills_dict):
    ...
    * Returns:
    ...
    new_job = Job(
        ...
        country    =  extract_text(html, "h1#results-list__title").split(" in ")[-1].strip(),
...
def parse_company_page(context, page1_html, companies_list):
    ...
    new_company = Company(
        ...
        industry = extract_text(html, 'div.org-top-card-summary-info-list__info-item:nth-child(1)'),
        company_size = extract_text(html, 'a.org-top-card-summary-info-list__info-item-link'),
